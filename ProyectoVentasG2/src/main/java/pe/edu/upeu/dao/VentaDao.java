...
public class VentaDao extends AppCrud{
    ...
    public void reporteVentasRangoFecha() {
        ...
        System.out.println(colorX.render("@|red T. Neto Ventas: S/.|@ @|green "+(Math.round(netoTotalX*100.0)/100.0)+"|@ | @|red "+
        "T. IGV a pagar:S/. |@ @|green "+ (Math.round(igvX*100.0)/100.0)+"|@ | @|red "+"Monto Recaudado: S/.|@ @|green "+
